...
public class MatrixMultiplication {
    public static void matrixMultiplication(int[][] a, int[][] b, int n, int[][] c) {
        if (n <= 2) {
            ...
            matrixMultiplication(a11, b11, mid, c11);
            matrixMultiplication(a12, b21, mid, c12);
            matrixMultiplication(a21, b12, mid, c21);
            matrixMultiplication(a22, b22, mid, c22);
